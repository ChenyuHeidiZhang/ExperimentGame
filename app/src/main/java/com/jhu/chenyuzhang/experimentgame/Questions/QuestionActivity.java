    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isDemo) {
            ...
            getAttributes();
            try {
                timeRecordDb.insertData(getCurrentTime(), "startTrainingTrial" + trial_num + "; Option1(Blue): A1=" + a1 + " P1=" + p1 + ", Option2(Green): A2=" + a2 + " P2=" + p2 + "; Orientation: vertical; " + position);
            } catch (Exception e) {
                Log.d("time db", "db error");
            }
